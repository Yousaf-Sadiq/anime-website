      ...
      <ul class="nav">
        <li class="nav-item">
          ...
          <div class="collapse" id="admin">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url("/admin-setting")}}"><i class="menu-icon mdi mdi-settings"></i> Admin setting</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="#products" aria-expanded="false" aria-controls="ui-basic">
            <i class="menu-icon mdi mdi-floor-plan"></i>
            <span class="menu-title">Anime Setting</span>
            <i class="menu-arrow"></i>
          </a>
          <div class="collapse" id="products">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="{{url("/All-anime")}}">All Anime</a></li>
              <li class="nav-item"> <a class="nav-link" href="{{url("/Add-anime")}}">Add New Anime</a></li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="cats">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link" href="{{url("/Add-anime-category")}}">All Categories</a></li>
              <li class="nav-item"><a class="nav-link" href="{{url("/Add-anime-category")}}">Add New Category</a></li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="SubCats">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link" href="{{url("/Slider-setting")}}">Add/All Slider</a></li>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="users">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"><a class="nav-link" href="{{url("All-user")}}">All Users</a></li>
