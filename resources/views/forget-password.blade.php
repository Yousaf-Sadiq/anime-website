                    ...
                    <div class="login__form">
                        ...
                        <form method="POST" action="{{ url('/forget-password') }}">
                            ...
                            <div class="input__item">
                                @if ($forget_pass[0]["email"]==request()->email)
                                <input type="email" disabled name="email_login" value="{{$forget_pass[0]["email"]}}" placeholder="Email address">

                                @else
                                <input type="email" name="email_login" value="{{request()->email}}" disabled placeholder="Email address">
