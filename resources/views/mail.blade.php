                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                    <div class="text">
                                        {{-- <h2>Ronald would like to be your friend on Anime webide</h2> --}}
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center;">
                                    <div class="text-author">
                                        <img src="{{Storage::url("/img/profile")}}/{{$details["getter"]["fetcher"][0]->profile}}" alt=""
                                            style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
                                        <h3 class="name">{{$details["getter"]["fetcher"][0]->user_name}}</h3>
                                        {{-- <span class="position">CEO, Founder at e-Verify</span> --}}
                                        {{-- <a href="{{ url('/forget-password') }}/{{ $details['email'] }}">Login</a> --}}
                                        <p><a href="{{ url('/forget-password') }}/{{ $details['email'] }}" class="btn btn-primary">Forget passwrod</a></p>
