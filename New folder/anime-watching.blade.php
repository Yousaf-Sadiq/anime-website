<x-header />
<link rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'" href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.css" >
{{-- rel="stylesheet" --}}
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__links">
                    ...
                    <a href="{{url("/category/")}}/{{$anime_flids[0][0]['add_anime_title']}}">{{$anime_flids[0][0]['add_anime_title'] }}</a>
...
<section class="anime-details spad d-flex flex-column flex-wrap justify-content-center ">
...
text-align: center;
            ...
            <div class="col-md-3 col-lg-3 col-xl-3  " id="order_2">
...
$count++;
            ...
            <div class="col-lg-9 col-md-9  text-center pl-md-5  pl-lg-5 pl-xl-5 pl-sm-5" id="order_1">
...
?>
                    ...
                    @if ($check_episode === $b)
                        ...
                        <input type="hidden" disabled id="iframe_value" value="<?php echo $save_url_episode['link'][$b]; ?>">
                        <style>
                        ...
                        <div style="width: 80%; height: 80%; " id="iframe">
                            ...
                            {{-- <IFRAME  class="lazyload embed-responsive-item" data-src="<?php echo $save_url_episode['link'][$b]; ?>" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO
                                allowfullscreen></IFRAME> --}}
                        </div>

                        <div class="player-controls" style="width: 80%; " id="light_dark">
                            ...
                            <div class="pc-item pc-toggle pc-light">
                                ...
                                @elseif (Session::has('user_email') && $anime_flids[2]['whishlist'][0] != '0')
                                    <div class="toggle-basic" id="favrt_delete" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Added to Favorite">
                                        <i class="fa fa-star fa-1x" style="font-size: 1rem; color:#E53637"
                                            aria-hidden="true"></i> <span> Delete from Favorite</span>
                                    </div>
                                @elseif (Session::has('user_email') && $anime_flids[2]['whishlist'][0] == '0')
                                    <div class="toggle-basic" id="favrt" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="click to add into Favorite">
                                        <i class="fa fa-star fa-1x" style="font-size: 1rem;" aria-hidden="true"></i>
                                        <span> Add to Favorite</span>
                                    </div>
                                @else
                                    <div class="toggle-basic" id="favrt_login" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="login to add favorite">
                                        <i class="fa fa-star fa-1x" style="font-size: 1rem;" aria-hidden="true"></i>
                                        <span> Add to Favorite</span>
                                    </div>
                                @endif
                            ...
                            <div class="pc-right">
                                ...
                                @if (isset($_GET['Ep']) && $_GET['Ep'] <= $length_full_data_file)
                                    <a href="<?php
        ...
        <div class="row justify-content-center">
            ...
            <div class="view"><i class="fa fa-eye"></i> 9141</div> --}}
                    ...
                    <div class="product__item__text">
                        ...
                        <h3 style="color: whitesmoke"> NO Anime and Episode Found</h3>
...
@endif
                        <div class="col-lg-3 " >
    <div class="{{$class}} hover1 anime__details__pic set-bg d-flex justify-content-center align-items-center" style="height:136px !important; position: relative;border-radius: 25px;"
    data-setbg="{{ Storage::url('/')}}/img/anime/{{$season->anime_image }}"        >
      ...
      <div class="item-overlay bottom d-flex flex-wrap justify-content-center align-items-center" style="z-index: 999999">
      <h2 class="color"  >
...
@endforeach
                    ...
                    <div class="row ">
                        <div class="col-lg-3 ">
                            ...
                            data-setbg="{{ Storage::url('img/anime') }}/error_404.gif" style="height:136px !important; position: relative;">
                            <div id="div1" class="d-flex justify-content-center align-items-center"> </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="anime__details__text">
                                ...
                                {{ print_r($anime_flids[1]['data_description']) }}
            ...
            <div class="col-lg-8">
                <div class="anime__details__form">
                    ...
                    <form action="{{ url('/anime-comments') }}" method="POST">
                        ...
                        <textarea placeholder="Your Comment" class="summernote" id="summernote" name="comments"></textarea>
                        @if (session('status'))
...
@endif --}}
                    <div class="anime__review__item" style="position: relative !important;">
                        <div class="anime__review__item__pic">
                            <img src="{{ Storage::url('profile/') }}{{$anime_comments->profile  }}"
                                alt="">
                        </div>
{{-- {{date("Y-m-d h:i:s")}} --}}
                 <div class="anime__review__item__text">

                            <h6>{{  $anime_comments->user_name}} - <span><?php
                                echo  dateDiff($anime_comments->created_at)

                    ?></span></h6>
@if (Session::get("user_email")==$anime_comments->email)

<h6  style="float: right !important;position: absolute;top: 11%;right: 3%;font-size: 1.1rem;z-index: 99999999999999999 !important;">


                                    <span  class="edit"  data-id-span={{$anime_comments->comment_id}}  style="cursor: pointer; float: right !important;"> ⋮</span>
                                </h6>
                                @endif
...
{{ print_r(Storage::get($anime_comments->comments)) }}
@else
...
<div>
    ...
    <button class="edit_btn edite_button"  style="display: none" id="edit_{{$anime_comments->comment_id}}" type="button"><i class="fa fa-location-arrow"></i> Review</button>
    <button class="edit_btn  close" style="display: none" id="close_{{$anime_comments->comment_id}}" type="submit"><i class="fa fa-times" aria-hidden="true"></i></i> close</button>
</div>
                        </div>
